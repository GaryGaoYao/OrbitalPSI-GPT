...
CONFIG = {
    ...
    "seed": 2024,
    "augment": True,
    "save_dir": r"D:\Codes\Skull_Landmarks_TL\Models-TIMM\runs\exp_heatmap_priors-ablation-v2",
...
ABLATIONS = [
    ...
    # —— 两两去除（6 组）——
    ("minus_sym_graph", {"sym": 0.0, "graph": 0.0}),
    ("minus_sym_edge",  {"sym": 0.0, "edge": 0.0}),
    ("minus_sym_ssm",   {"sym": 0.0, "ssm": 0.0}),
    ("minus_graph_edge",{"graph": 0.0, "edge": 0.0}),
    ("minus_graph_ssm", {"graph": 0.0, "ssm": 0.0}),
    ("minus_edge_ssm",  {"edge":  0.0, "ssm": 0.0}),

    # —— 三项去除（4 组）——
    ("minus_sym_graph_edge", {"sym": 0.0, "graph": 0.0, "edge": 0.0}),
    ("minus_sym_graph_ssm",  {"sym": 0.0, "graph": 0.0, "ssm": 0.0}),
    ("minus_sym_edge_ssm",   {"sym": 0.0, "edge":  0.0, "ssm": 0.0}),
    ("minus_graph_edge_ssm", {"graph":0.0, "edge": 0.0, "ssm": 0.0}),
]
