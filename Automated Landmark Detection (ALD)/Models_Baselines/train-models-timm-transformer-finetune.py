...
CONFIG = {
    ...
    # 训练与日志
    "img_size": 224,  # CNN 随意; Transformer 类一般用 224
    "batch_size": 40, # resnet18：480 其他312 densenet121--->smaller: 240
    "lr": 1e-3,
    "epochs": 250,
    "val_ratio": 0.15,
    "seed": 2024,
    "augment": True,
    "save_dir": r"D:\Codes\Skull_Landmarks_TL\Models-TIMM\runs\exp_timm_large_finetune",
