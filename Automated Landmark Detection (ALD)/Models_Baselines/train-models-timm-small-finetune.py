...
CONFIG = {
    ...
    "batch_size": 120, # resnet18：480 其他312 densenet121--->smaller: 240
    "lr": 1e-3,
    "epochs": 250,
    "val_ratio": 0.15,
    "seed": 2024,
    ...
    "num_workers": 8,      # Windows/Thonny 卡住就设 0
    "pin_memory": True,
    "tb_samples": 2,
...
# =========================
# 封装：单个骨干的一次完整训练（含 Cosine LR + TB 记录 LR + Early Stop）
# =========================
...
# 1) 改 CONFIG 里的路径
# 2) 运行本脚本开始训练
# 3) 打开 TensorBoard 查看所有骨干日志：
#    tensorboard --logdir "D:\Codes\Skull_Landmarks_TL\Models-TIMM\runs\exp_timm_small_finetune\resnet18"
